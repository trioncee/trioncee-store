  ...
  return (
    ...
    >
      <header className="mb-16 text-center">
        <span className="text-[10px] uppercase tracking-[0.6em] text-neutral-400 mb-4 block">Collection 2026</span>
        <h1 className="text-5xl font-light tracking-tight mb-8 uppercase">The Essential Series</h1>
        ...
        {filteredProducts.map((product, idx) => (
          ...
          >
            <Link to={`/product/${product.id}`} className="group block">
              <div className="aspect-[3/4] bg-neutral-100 overflow-hidden mb-8 relative border border-neutral-200 flex items-center justify-center">
                {product.images[0] ? (
                  <img
              ...
              <div className="space-y-2 text-center">
                <h3 className="text-[11px] font-bold tracking-[0.25em] uppercase text-neutral-800">{product.name}</h3>
                <div className="flex justify-center items-center gap-4 text-[10px] text-neutral-400 uppercase tracking-widest">
